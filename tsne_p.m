function ydata = tsne_p(P, labels, no_dims, motivation)
...
% University of California, San Diego
    ...
    for iter=1:max_iter
        ...
        mydata = ydata(1:length(motivation), :);
        mlabels = motivation;
        ...
        if ~rem(iter, 10) && ~isempty(labels)
            ...
            elseif no_dims == 2
                scatter(ydata(:,1), ydata(:,2), 16, labels, 'filled');
                text(mydata(:,1), mydata(:,2),mlabels,'HorizontalAlignment','left');
            else
